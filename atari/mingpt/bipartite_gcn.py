...
import json
import time
from mingpt.bipartite_graph_convolution import BipartiteGraphConvolution
...
class BipartiteGCN(torch.nn.Module):
    ...
    def init_nn_modules(self, 
        ...
        self.conv_v_to_c = BipartiteGraphConvolution(emb_size=emb_size, aggregator=aggregator, include_edge_features=self.include_edge_features)
        self.conv_c_to_v = BipartiteGraphConvolution(emb_size=emb_size, aggregator=aggregator, include_edge_features=self.include_edge_features)
